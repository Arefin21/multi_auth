		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Seller Login</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				...
				@endif
		      	...
		      	<form action="{{route('seller.login')}}" class="signin-form" method="post">
					@csrf
	          ...
	          <p class="w-100 text-center"><a href="{{route('admin.register')}}">Create New Accout</a></p>
